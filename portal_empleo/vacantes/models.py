...
class RegistroCandidato(models.Model):
    ...
    formacion_academica = models.CharField(max_length=50, choices=EDUCATION_LEVEL_CHOICES)
    ...
    tecnico_seleccion = models.CharField(max_length=50, choices=RECRUITER_CHOICES, blank=True, null=True)
